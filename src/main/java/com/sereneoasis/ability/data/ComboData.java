...
public class ComboData extends AbilityData {
    ...
    public ComboData(Archetype archetype, String description, String instructions, long chargetime, long cooldown, long duration, double damage,double hitbox, double radius, double range, double speed, double sourcerange, ArrayList<ComboManager.AbilityInformation> abilities) {
