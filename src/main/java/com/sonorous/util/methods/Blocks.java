...
public class Blocks {
    ...
    public static boolean isBelowArchetype(Block b, double distance, SonorousAbilitiesPlayer serenityPlayer) {
        Location loc = b.getLocation();
...
//        Particles.spawnParticle(Particle.FLAME, highest, 1, 0, 0);
    ...
    public static Set<Material> getArchetypeBlocks(SonorousAbilitiesPlayer serenityPlayer) {
        return ArchetypeDataManager.getArchetypeData(serenityPlayer.getArchetype()).getBlocks();
    }

    public static Block getSourceBlock(Player player, SonorousAbilitiesPlayer sPlayer, double sourceRange) {
