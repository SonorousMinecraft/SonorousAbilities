...
import com.sonorous.ability.data.AbilityData;
...
import static com.sonorous.SonorousAbilitiesPlayer.initialisePlayer;
...
//                        return true;
                    ...
                    case "unbind" -> {
                        ...
                        if (strings.length > 2) {
                            ...
                            SonorousAbilitiesBoard.getByPlayer(player).setAbilitySlot(slot, nullAbility);
                            return true;
                        }
                    }
                    case "preset", "p" -> {
